function calculate() {
    var watts = parseInt(document.getElementById('watts').value);
    var time = parseInt(document.getElementById('time').value);
    var timeUnit = document.getElementById('time-unit').value;
    var kwh = parseFloat(document.getElementById('kwh').value);

    // Check if any of the input values are empty or NaN
    if (isNaN(watts) || isNaN(time) || isNaN(kwh)) {
        ...
        var energyUsed = watts * timeUsed;
        var energyUsedInKwh = energyUsed / 1000.0;
        var result = energyUsedInKwh * kwh;
